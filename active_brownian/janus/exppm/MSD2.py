...
from formulas import Dex_exponential_f,Dex_plusminus_f,Dex_plusminus_a
...
# data_msd = np.loadtxt('./copyresult2Dexp2/MSD_lags.dat')
...
print(f'Defftheoryfourier = {(DT+Dex_plusminus_f(v,T,tau,1/DR,N=int(1e6))):.6f}')
print(f'Defftheory        = {(DT+Dex_plusminus_a(v,T,tau,1/DR)):.6f}')
print(f'Defftheoryfourier = {(DT+Dex_exponential_f(v,T,tau,1/DR,N=int(1e5))):.6f}')
