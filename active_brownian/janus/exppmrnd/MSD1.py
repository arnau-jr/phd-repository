...
data_vel = np.loadtxt('./result2Dexp1/vel.dat')
data_velabs = np.loadtxt('./result2Dexp1/velabs.dat')
...
plt.savefig('plots/velabs1.pdf',format='pdf',bbox_inches='tight',pad_inches=0.02)
